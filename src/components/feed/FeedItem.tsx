...
const FeedItem: React.FC<Props> = ({ item }) => {
  ...
  return (
    <div style={{ borderRadius: 22, overflow: 'hidden', boxShadow: '0 14px 34px rgba(0,0,0,0.25)', background: CARD_BG, border: '1px solid rgba(0,0,0,0.08)' }}>
      {imageUrl && (
      ...
      <div style={{ padding: 16 }}>
        ...
        {item.linkUrl && (
          <a href={item.linkUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'block', marginTop: 14, padding: '12px 16px', background: WHITE, color: RED, borderRadius: 10, textAlign: 'center' as const, fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>

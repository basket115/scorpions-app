...
const SocialBar: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', gap: 12, alignItems: 'center', background: 'rgba(255,255,255,0.92)', borderRadius: 12, marginTop: 14, padding: '10px 14px' }}>
